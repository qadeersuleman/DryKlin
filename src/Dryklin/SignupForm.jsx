    ...
    if (Object.keys(formErrors).length > 0) {
      ...
      try {
        const csrfResponse = await axios.get(
          "https://dryklin-e853d5ecea30.herokuapp.com/api/signup/"
        );
          ...
          >
            ...
            <Form className="w-100" onSubmit={handleSubmit}>
              ...
              <Form.Group controlId="formPhoneNumber">
                ...
                <div className="phone-input-container input-data">
                  ...
                  <Form.Control
                    ...
                    className="phone-input-field input-data btnsss"
            ...
            <div className="phone-input-container input-data">
              <div className="prefix-container">
                <img
                  ...
                  className="flag-icon"
                />
                <select className="country-code-dropdown" name="country_code"
                style={{fontSize : "12px"}}
                >
